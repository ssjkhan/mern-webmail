...
app.get("/mailboxes", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.get("/mailboxes/:mailbox", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
...
app.get("/messages/:mailbox/:id", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
...
app.delete("/messages/:mailbox/:id", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
...
app.post("/messages", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.get("/contacts", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.post("/contacts", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contactsWorker = new Contacts.Worker();
...
app.delete("/contacts/:id", (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contactsWorker = new Contacts.Worker();
